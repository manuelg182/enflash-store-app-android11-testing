...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        main_title.setText("Cambiar contraseña ");
    ...
    private void init() {
        ...
        if (extras != null) {
            if (extras.containsKey("destination")) {
                ...
                String textToDisplay = "Un código para cambiar la contraseña fue enviado a " + dest + " via " + delMed;
    ...
    private void getCode() {
        ...
        if (newPassword == null || newPassword.length() < 1) {
            ...
            passwordInput.setError("Campo requerido.");
            return;
        }
        ...
        if (verCode == null || verCode.length() < 1) {
            ...
            codeInput.setError("Campo requerido.");
            return;
        }
